				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">Vignan<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
	...
	<div class="mail">
		...
		<div class="container">
			<div class="map footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4336.90260799849!2d83.16110621218809!3d17.710647357036635!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a3968cb428b8087%3A0xaa3e198c43836a65!2sVignan&#39;s%20Institute%20Of%20Information%20Technology!5e0!3m2!1sen!2sin!4v1663157138575!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen></iframe>
			</div>
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contact Us</h3>	
					<p></p>				
					<h4>Vignan's institute of information technology</h4>
					<p>Duvada-Vishakapatnam,
						<span>Andhra pradesh</span>
						India IN-530 049
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: 0891-2755222/333/444/555
						<span>FAX: +91 830-1979790</span>
						E-mail: <a href="mailto:vignaniit@yahoo.com">vignaniit@yahoo.com</a>
					</p>
				</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Vignan's institute of information technology</h6>
					<h4>
			...
			<div class="container">
              ...
              <a href="http://znumerique.azurewebsites.net" target="_parent">MCA</a>
				...
				<div class="copyright-right wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<ul>
						<li>
							<a href="https://twitter.com/vignaniit" class="twitter"> </a>
						</li>
						<li>
							<a href="https://www.facebook.com/VignansInstituteofInformationTechnologyVIIT/" class="twitter facebook"> </a>
						</li>
						<li>
							<a href="http://vignaniit.edu.in/" class="twitter chrome"> </a>
						</li>
						
						<li>
							<a href="https://www.linkedin.com/company/viitvizag" class="twitter linkedin"> </a>
						</li>
