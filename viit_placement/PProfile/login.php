    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <div class="profile-photo-container">
          <img src="images/b119.jpeg" alt="Profile Photo" class="img-responsive">
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
               <li><a href="../Homepage/home.php"">Home Vignan</a></li>
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-flex-row flex-content-row">
            <div class="templatemo-content-widget white-bg col-2">
              ...
              <div class="square"></div>
              <h2 class="templatemo-inline-block">Welcome to Vignan</h2>
              <p></p>
              <p>Hello Officer! Have a great day with us! With Vignan Account, You can add drives, Send Notifications and View the Eligibility Criteria of Students.</p>
